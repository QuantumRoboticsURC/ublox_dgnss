...
public:
      ...
      .automatically_declare_parameters_from_overrides(true))
  {
    ...
    latitude_pub = this->create_publisher<std_msgs::msg::Float64>("latitude", 10);
    longitude_pub = this->create_publisher<std_msgs::msg::Float64>("longitude", 10);
    //
...
// Iker Fuentes
  rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr latitude_pub;
  rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr longitude_pub;
...
private:
  ...
  void ubx_nav_pvt_pub(ubx_queue_frame_t * f, std::shared_ptr<ubx::nav::pvt::NavPvtPayload> payload)
  {
    ...
    auto latitude = std_msgs::msg::Float64();
    auto longitude = std_msgs::msg::Float64();
    latitude.data = payload->lat;
    longitude.data = payload->lon;
